...
async function main() {
  ...
  if (!domain) {
    console.log("No deployment domain found — skipping static Expo build (local environment).");
    console.log("To run locally: cd artifacts/mobile && pnpm exec expo start");
    process.exit(0);
  }
